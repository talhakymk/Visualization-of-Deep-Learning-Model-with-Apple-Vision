...
# Source directory
source_dir = "/Users/melikeseyitoglu/Documents/Talha/DeepLearningModelVisualization/Assets/StreamingAssets/feature_maps_alexnet/+dog"

# Destination directory
dest_dir = "/Users/melikeseyitoglu/Desktop/Visualization of DeepLearning/Visualization of DeepLearning/Assets.xcassets/Alexnet/dog"
...
def copy_layer_files(source_layer, dest_layer, count):
    ...
    for i, source_path in enumerate(source_files):
        # Destination: dog_{layer}_{index}.png
        dest_filename = f"dog_{dest_layer}_{i}.png"
        dest_imageset_dir = Path(dest_dir) / dest_layer / f"dog_{dest_layer}_{i}.imageset"
...
def main():
    print("Starting to copy PNG files from source to dog asset structure...")
